                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            margin-left: 0px;">
                                ...
                                <div class= "border pb-2 other-div d-none mb-3">

                                        <div class="col-md-12 other-div d-none mb-2 ">
                                            <label class=" d-block pt-10">{{ __('Primary Doctor Name') }}</label>
                                            <input name="pri_doctor_name"  id="" class="form-control" cols="30" rows="5" placeholder="Primary Doctor Name" value="">
                                        </div>
                                        <div class="col-md-12 other-div d-none mb-2">
                                            <label class=" d-block pt-10">{{ __('Primary Doctor Phone') }}</label>
                                            <input name="pri_phone_no"  id="" class="form-control" cols="30" rows="5" placeholder="Primary Doctor Phone" value="">
                                        </div>
                                        <div class="col-md-12 other-div d-none mb-2">
                                            <label class=" d-block pt-10">{{ __('Primary Doctor State') }}</label>
                                            <input name="pri_state"  id="" class="form-control" cols="30" rows="5" placeholder="Primary Doctor State" value="">
                                        </div>
                                        <div class="col-md-12 other-div d-none mb-2">
                                            <label class=" d-block pt-10">{{ __('Primary Doctor Address') }}</label>
                                            <input name="pri_address"  id="" class="form-control" cols="30" rows="5" placeholder="Primary Doctor Address" value="">
                                        </div>
                                        <div class="col-md-12 other-div d-none mb-2">
                                            <label class=" d-block pt-10">{{ __('Primary Doctor Pincode') }}</label>
                                            <input name="pri_pincode"  id="" class="form-control" cols="30" rows="5" placeholder="Primary Doctor Pincode" value="">
                                        </div>
                                </div>
