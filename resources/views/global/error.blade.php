        ...
        <div class="row">
            <div class="col-12">
                <div class="card form-signin p-4 rounded shadow" style="max-width: fit-content;margin-top:30px;" >
                    ...
                    <h1 style="font-weight: 400; font-family: system-ui;">Ooops! Something went wrong</h1>
                    <h6> The page you're looking for no longer exists.<br> Go back to the <a href={{ route('index')}}> home page </a></h6>
