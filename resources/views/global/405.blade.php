...
@section('meta_data')
    @php
		$meta_title = '405 | '.getSetting('app_name');		
        ...
        <div class="row">
            <div class="col-12">
                <div class="card form-signin p-4 rounded shadow" style="max-width: 850px; margin-top:5px;" >
                    <div class="card-body">
                        <h1 style="color: #1969d3; font-weight:500 ; font-family: system-ui; margin-top: -10px;">405</h1>
                        {{-- <img src="{{ asset('frontend/customer/icons/404.png') }}"alt="404" width= "100px" class="img-fluid"> --}}
                    <h1 style="font-weight: 400; font-family: system-ui;">Method Not Allowed</h1>
                    <h6> This request is not supported by the resource.</h6>
