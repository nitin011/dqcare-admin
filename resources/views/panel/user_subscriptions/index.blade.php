 ...
 */
    $breadcrumb_arr = [
        ['name'=>'User Subscriptions', 'url'=> "javascript:void(0);", 'class' => 'active']
    ]
    @endphp
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Subscribers</h5>
                            <span>List of  Subscriptions</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <form action="{{ route('panel.user_subscriptions.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-flex justicy-content-right">
                             <div class="form-group mb-0 mr-2">
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.user_subscriptions.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a>
                                 <a href="{{ route('panel.user_subscriptions.create') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New User Subscription"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.user_subscriptions.load')
                        </div>
                    </div>
                </div>
            </div>
