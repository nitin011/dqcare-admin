 ...
 */
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Patient Files</h5>
                            <span>List of Patient Files</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <form action="{{ route('panel.patient_files.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="mb-3">Patient Files</h3>
                            ...
                            <div class="d-flex justicy-content-right">
                                ...
                                <div class="form-group mr-2 d-flex align-items-center">
                                    ...
                                    <select name="category" id="" class="form-control select2">
                                        <option value="" aria-readonly="true">Select Category</option>
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.patient_files.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" onClick="reload()" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a>
                                <a href="{{ route('panel.patient_files.create') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New Patient File"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                                       
                        </div>
                        <div id="ajax-container">
                            @include('panel.patient_files.load')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        ...
        function html_table_to_excel(type)
        {
            ...
            XLSX.writeFile(file, 'PatientFileFile.' + type);
        ...
        $('#reset').click(function(){
            window.location.href = "{{route('panel.patient_files.index')}}";
        });
