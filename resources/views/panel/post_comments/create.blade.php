 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add Post Comment', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>Create a record for Post Comment</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>Create Post Comment</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.post_comments.store') }}" method="post" enctype="multipart/form-data" id="PostCommentForm">
                            @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="post_id" id="post_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\PostManagement::all()  as $option)
                                                <option value="{{ $option->id }}" {{  old('post_id') == $option->id ? 'Selected' : '' }}>{{ NameById($option->id)}}  </option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea  required   class="form-control" name="comment" id="comment" placeholder="Enter Comment">{{ old('comment')}}</textarea>
                                    </div>
                                </div>
