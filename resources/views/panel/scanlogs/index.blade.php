 ...
 */
    $breadcrumb_arr = [
        ['name'=>'Scanlogs', 'url'=> "javascript:void(0);", 'class' => 'active']
    ]
    @endphp
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('panel.scanlogs.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-flex justicy-content-right">
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.scanlogs.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a>
                                                                <a href="{{ route('panel.scanlogs.create') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New Scanlog"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.scanlogs.load')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        ...
        function html_table_to_excel(type)
        {
            ...
            XLSX.writeFile(file, 'ScanlogFile.' + type);
        ...
        $('#reset').click(function(){
            window.location.href = "{{route('panel.scanlogs.index')}}";
        });
