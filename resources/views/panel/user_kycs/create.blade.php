 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add User Kyc', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add User Kyc</h5>
                            <span>Create a record for User Kyc</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>Create User Kyc</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.user_kycs.store') }}" method="post" enctype="multipart/form-data" id="UserKycForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('details') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="details" type="text" id="details" value="{{old('details')}}" placeholder="Enter Details" >
                                    </div>
                                </div>
