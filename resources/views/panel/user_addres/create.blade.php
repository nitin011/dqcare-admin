 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add User Addre', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add User Addre</h5>
                            <span>Create a record for User Addre</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3>Create User Addre</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('panel.user_addres.store') }}" method="post" enctype="multipart/form-data" id="UserAddresForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea  required   class="form-control" name="details" id="details" placeholder="Enter Details">{{ old('details')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('is_primary') ? 'has-error' : ''}}"><br>
                                        ...
                                        <input    required  class="js-single switch-input" @if(old('is_primary'))   @endif name="is_primary" type="radio" id="is_primary" value="1" >
                                    </div>
                                </div>
