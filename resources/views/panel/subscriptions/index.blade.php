 ...
 */
    $breadcrumb_arr = [
        ['name'=>'Subscriptions', 'url'=> "javascript:void(0);", 'class' => 'active']
    ]
    @endphp
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('panel.subscriptions.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-flex justicy-content-right">
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.subscriptions.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a> --}} 
                            <a href="{{ route('panel.subscriptions.create') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New Subscription"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.subscriptions.load')
                        </div>
                    </div>
                </div>
            </div>
