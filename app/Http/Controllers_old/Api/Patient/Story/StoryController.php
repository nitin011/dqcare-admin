...
class StoryController extends Controller
{
    ...
    public function storyOrganizeRequest(Request $request)
    {
        try {
            ...
            if($storyRecord->updated_at != null){
            ...
            if($storyRecord && $storyRecord->updated_at){
	...
	public function patientSummaryUpdate(Request $request, $id)
    {
        try {
            ...
            if ($stories) {
				...
				$known_cases = isset($request->known_cases)? ','.$request->known_cases:'';
				$any_allergy = isset($request->any_allergy)? ','.$request->any_allergy:'';
				$current_medication = isset($request->current_medication)? ','.$request->current_medication:'';
				
				$arr['detail']['known_cases'][0]['known_text'] = $stories['detail']['known_cases'][0]['known_text'].$known_cases;
				$arr['detail']['family_history'][0]['family_text'] = $stories['detail']['family_history'][0]['family_text'];
				$arr['detail']['operative_history'][0]['operative_text'] = $stories['detail']['operative_history'][0]['operative_text'];
				$arr['detail']['habit_history'][0]['habit_text'] = $stories['detail']['habit_history'][0]['habit_text'];
				$arr['detail']['any_allergy'][0]['allergy_text'] = $stories['detail']['any_allergy'][0]['allergy_text'].$any_allergy;
				$arr['detail']['current_medication'][0]['current_text'] = $stories['detail']['current_medication'][0]['current_text'].$current_medication;
				$arr['detail']['vaccination_history'][0]['vaccination_history'] = $stories['detail']['vaccination_history'][0]['vaccination_history'];
				$arr['detail']['opd_visit'][0]['opd_text'] = $stories['detail']['opd_visit'][0]['opd_text'];
				$arr['detail']['last_admitted'][0]['last_text'] = $stories['detail']['last_admitted'][0]['last_text'];
				$arr['detail']['bloodGroup'][0]['bloodGroup_text'] = $stories['detail']['bloodGroup'][0]['bloodGroup_text'];
				$arr['detail']['summary'] = $stories['detail']['summary'];
