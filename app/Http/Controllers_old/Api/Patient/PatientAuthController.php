...
class PatientAuthController extends Controller
{
    public function patientLogin(Request $request)
    {
        ...
        if (!$user->exists()) {
            ...
            pushSMSNotification($user->phone, "Welcome! Respected Doctor. Thank you for joining HealthDetails. Now you can track appointments, manage your patient's details, medical story, referrals and take regular followup updates easily on your HealthDetails app.");
            ...
            if ($user) {
                if ($UserPhone->first()) {
                    if ($UserPhone->role('Doctor')->first()) {
                        ...
                        $message = "Hello Dr $doctor_name, $patient_name added you as a primary doctor in HealthDetails. Free your patients from physical files and get to see their smart digital health file everytime they visit. Also, digitalise your practise . Welcome to era of digital health. Download Healthdetails app today https://healthdetails.in .";
