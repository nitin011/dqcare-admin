...
class MemberController extends Controller
{
    ...
    public function linkMember(Request $request)
    {
        ...
        try {
            ...
            callWhatsappNotification($user->first()->phone, "Hey $doctor_name, $user_name linked you as a family member in DQ Care account. Now enjoy the shared subscription and manage your digital health file easily. Welcome to era of digital health. Download DQ Care app today https://dqcare.in .");
